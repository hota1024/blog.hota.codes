...
export const metadata: Metadata = {
  title: "技術系の記事一覧",
  alternates: {
    canonical: `${siteData.siteURL}/categories/tech`,
  },
};
  ...
  return (
    <div className="flex flex-col gap-10 px-2 md:gap-16 lg:px-4">
      <div className="flex flex-col gap-8">
        <h1 className="text-center text-4xl font-black">TECH 記事一覧</h1>
        <p className="text-center text-muted-foreground">
          TECH は技術系の記事をまとめたカテゴリです。
        </p>
      </div>
      <PostsGrid posts={getPostsByCategory("tech")} />
    </div>
  );
}
